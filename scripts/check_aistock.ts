...
try {
 ...
 `,
              ...
              contents:
                path === 'env'
                  ...
                  : path === 'headers'
                    ...
                    : 'export async function getChatGPTUser(){return globalThis.aistockTestUser} export const getAuthenticatedUser=getChatGPTUser; export const getBillingAuthenticatedUser=getChatGPTUser; export async function getVerifiedChatGPTIdentity(){return null}',
              loader: 'js',
            }),
          );
        },
  ...
  const flow = await api.beginGoogleFlow(null);
  ...
  console.log(
    'AIstock checks passed: isolated D1/R2; posts/replies and retry safety; private notes/edit/import/stocks; PNG metadata and image access; verified tickets and Google JWT; disabled paid endpoints.',
  );
} finally {
  globalThis.fetch = originalFetch;
  await mf.dispose();
