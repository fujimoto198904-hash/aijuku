...
const sections = [
  [
    '1. 取得する情報',
    'ChatGPTによる本人確認で提供される利用者識別子、メールアドレス、表示名、会員登録日時、受講の申込内容、申込時点の表示料金、人数、希望日時、対応状況、担当講師、確定日時、会場・Google Meet案内、運営の対応記録、学習課題・成果物名・説明・外部URL・公開設定・講師確認記録を取得します。電話番号は取得しません。',
  ],
  [
    '2. 利用目的',
    '無料会員の本人確認とマイページ提供、受講希望の受付・確認・連絡、学習記録と講師確認、本人が選んだ応募用プロフィールのURL共有、予約・会場・Google Meet・料金等の案内、問い合わせ対応、不正利用防止、サービスの安全な運営と改善、法令上必要な対応のために利用します。',
  ],
  [
    '3. 第三者提供と委託',
