...
const sections = [
  [
    "1. 対象",
    "本規約は、藤本実学塾が提供する無料会員機能、マイページ、AI実学パスポート、第三者評価、URL共有プロフィールの利用に適用されます。有料受講の契約条件、支払い、変更、取消、返金等は、各申込時に別途提示する条件が優先します。",
  ],
  [
    "2. 無料会員登録",
  ...
  [
    "5. 禁止事項",
    "他人になりすます行為、自分の成果物を第三者として評価する行為、虚偽の成果・所属・関係・確認範囲を登録する行為、顧客情報・社外秘・第三者の個人情報・権利未確認素材を無断掲載する行為、サービス運営を妨げる行為、不正アクセス、法令または公序良俗に反する行為、教材やシステムを無断で複製・再配布する行為を禁止します。",
  ],
  [
    "6. 教材とAI出力",
  ...
  [
    "7. AI実学パスポート",
    "AI実学パスポートは、受講生が登録した実践記録と、講師・運営および第三者が実際に確認した範囲を分けて表示する学習記録です。能力全体、公的資格、勤務先、職歴、雇用適性、採用結果を保証するものではありません。講師確認済みの表示は、記載された範囲を当塾が確認したことだけを意味します。",
  ],
  [
    "8. 成果物の記録と共有",
  ...
  [
    "9. 第三者評価",
    "第三者評価者は、実際に見た成果物と場面について、事実に基づいて入力してください。所属・受講生との関係は自己申告です。評価者の公開同意がない内容は共有プロフィールへ掲載せず、同意がある場合も運営確認後に表示します。成果物が差し戻しまたは再提出された場合、旧版への評価は掲載対象外となり、再確認後に新しい評価が必要です。評価者は運営本部へ連絡して自分の評価の非公開・削除を依頼できます。",
  ],
  [
    "10. 停止・変更",
