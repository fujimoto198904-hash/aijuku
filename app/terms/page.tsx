...
const sections = [
  [
    '1. 対象',
    '本規約は、藤本実学塾が提供する無料会員機能、マイページ、課題のブックマーク・完了記録、AI実学パスポート、URL共有プロフィールの利用に適用されます。有料受講の契約条件、支払い、変更、取消、返金等は、各申込時に別途提示する条件が優先します。',
  ],
  [
    '2. 無料会員登録',
    `会員登録自体は無料です。新規登録では、まず本人のChatGPTアカウントでメールアドレスを確認し、その後は登録したログインIDとパスワードで利用できます。${sharedFees.entranceCampaign}は入会金${sharedFees.entrance}（${sharedFees.entranceRegular}）です。${sharedFees.entranceCondition}キャンペーンの適用可否と受講料は申込前に案内します。`,
  ],
  [
    '3. アカウント管理',
    '初回パスワードには登録時に入力した生年月日8桁を使い、初回利用時は同じメールアドレスのChatGPT本人確認も行います。発行から72時間以内に、登録直後または初回ログイン時に本人だけが知る新しいパスワードへ変更することを必須とします。生年月日そのものと入力した8桁の値は保存しません。会員は、ChatGPTアカウント、ログインID、パスワードを第三者に利用させないでください。パスワードを忘れた場合のメール相談は登録メールアドレスから受け付けますが、自動再設定機能と具体的な復旧方法は現在準備中です。デモアカウントは閲覧のみで、申込、学習記録、プロフィール変更、管理操作はできません。不正利用に気づいた場合は、速やかに運営本部へ連絡してください。',
  ],
  [
    '4. 申込の扱い',
    'マイページからの送信は、受講希望の受付です。送信だけでは、日程、会場、講師、Google Meet、料金、契約、決済は確定しません。当塾が申込を確定すると、オンライン授業と家庭教師型の対面授業は、運営者本人のGoogleカレンダーへ予定を作成します。オンライン授業では専用のGoogle Meetも作成し、確定後のマイページに表示します。受講生をGoogle予定の参加者には追加せず、受講生のカレンダーには書き込みません。対面・教科書自習式は、月額申込から毎日の来場予定を自動作成しません。',
  ],
  [
    '5. 禁止事項',
  ...
  [
    '6. 教材とAI出力',
    'Web教科書は学習支援を目的とします。課題の「あとでやる」と「完了」は会員本人が設定する学習メモであり、出席、提出、講師確認、修了認定ではありません。AIの出力は下書きであり、氏名、数字、期限、権利、公開・送信・契約等は利用者自身が確認してください。公的資格や各AI提供会社の公式認定を示すものではありません。',
  ],
  [
    '7. AI実学パスポート',
