...
export const faqItems = [
  {
    ...
    answer: allLessonDetailsPublished
      ? `はい。呼ばれたい名前や、作りたい文章を伝える短い課題から始めます。全${textbookCatalog.stats.total}課題に、使う材料から完成条件までの詳しい本文と練習素材があります。全員が同じ順番・速度で進む形式ではありません。`
      : `はい。呼ばれたい名前や、作りたい文章を伝える短い課題から始めます。現在${textbookCatalog.stats.lessonDrafts}課題に詳しい本文があり、残り${textbookCatalog.stats.outlines}課題は選べる骨格を公開しています。全員が同じ順番・速度で進む形式ではありません。`,
  },
  {
    question: "730の制作ミッションを、全部受けるのですか？",
    answer:
      "いいえ。730は、最終的にこのサイトで公開する選択肢の総数です。いま作りたいものを一つ決め、共通・部署別・業種別・生成特化から必要な教材だけを使います。同じ成果物を教材ごとに作り直すことはしません。",
  },
  {
    question: "このサイトだけで、本当に無料で学べますか？",
    answer: `Web教科書は、登録も購入も不要で、無料で読めます。詳しい手順がある${textbookCatalog.stats.lessonDrafts}課題から、今日すぐにAIの勉強を始められます。${allLessonDetailsPublished ? "" : `残り${textbookCatalog.stats.outlines}課題の詳しい本文は順次公開します。`}実践にはPCとChatGPT等を使い、学び方に迷ったときや講師へ直接質問したいときだけ、有料のオンライン・対面受講を選べます。講師対応、会場利用、紙の教科書は有料です。無料会員登録だけで自動課金されることはありません。`,
  },
  {
  ...
  },
  {
    ...
    answer:
      "いいえ。Web教科書だけでも学べるよう、全課題をこのサイトへ順次公開します。紙で手元に置きたい方だけ、1冊2,000円前後の紙版を別途購入できる形を予定しています。",
  },
  {
    question: "AI実学パスポートは資格として使えますか？",
    answer:
      "資格ではありません。作った成果物、講師が確認した範囲、同意を得た第三者評価を分けて残し、応募時に「何ができるか」を具体的に説明しやすくする藤本実学塾独自の記録です。国家資格・公的資格やAI提供会社の公式認定、採用結果を保証するものではありません。",
  },
] as const;
